...
import { Settings, LogOut, Grid, Bookmark, MessageSquare, Palette, X, Twitter, Instagram } from 'lucide-react';
import { THEMES } from '../theme';
import { MOCK_CITIES } from '../mockData';
import { motion, AnimatePresence } from 'framer-motion';

export const Profile: React.FC = () => {
  const { user, theme, setThemeKey, logout, login, updateUser, activeCity } = useApp();
      ...
      <div className="px-6 pt-6 pb-10 flex flex-col items-center text-center">
        ...
        <div className="flex gap-8 mb-8">
          <div className="text-center">
            <span className="block font-black text-xl italic tracking-tighter">1.2K</span>
            <span className="text-[10px] uppercase font-black tracking-widest opacity-40">Followers</span>
          </div>
          <div className="text-center">
            <span className="block font-black text-xl italic tracking-tighter">482</span>
